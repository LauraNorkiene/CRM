...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="card mt-5">
                <div class="card-header">Pridėti įmonę</div>
                <div class="card-body ">
                    <form action="" method="POST">
                        ...
                        <div class="mb-3">
                            <label for="" class="form-label">PVM kodas</label>
                            <input name="vat_code" type="text" class="form-control">
                        </div>
                        <div class="mb-3">
                            <label for="" class="form-label">Įmonės pavadinimas</label>
                            <input name="company_name" type="text" class="form-control" required>
                        </div>
                        <div class="mb-3">
                            <label for="" class="form-label">Telefono numeris</label><br>
